...
namespace GestorHorarioG6.Controllers
{
    public class TrocasController : Controller
    {
        ...
        {
            var gestorHorarioG6Context = _context.Trocas.Include(t => t.Funcionario);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["FuncionarioId2"] = new SelectList(_context.Funcionario, "FuncionarioId2", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("TrocasID,FuncionarioId,FuncionarioId2,DiaF1,DiaF2,Conhecimento,Aprovado")] Trocas trocas)
        {
            ...
            ViewData["FuncionarioId2"] = new SelectList(_context.Funcionario, "FuncionarioId2", "Nome", trocas.FuncionarioId2);
            return View(trocas);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TrocasID,FuncionarioId,FuncionarioId2,DiaF1,DiaF2,Conhecimento,Aprovado")] Trocas trocas)
        {
